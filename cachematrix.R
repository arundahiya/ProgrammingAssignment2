## Taken together, these functions cache the inverse of a matrix 
## that we input to the funcion. Once the inverse is calculated,
##it is cached for easy and quick access.
